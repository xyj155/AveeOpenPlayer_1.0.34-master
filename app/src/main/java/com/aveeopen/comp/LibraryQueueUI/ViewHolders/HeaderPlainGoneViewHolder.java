...
public class HeaderPlainGoneViewHolder
        extends BaseViewHolder {

    public HeaderPlainGoneViewHolder(Context context, ViewGroup parent) {
        super(UtilsUI.getInflaterFromContext(context).inflate(R.layout.header_plain_gone_item, parent, false));
    }

...
public class HeaderAlbumsViewHolder
        extends BaseHeaderViewHolder {

    public HeaderAlbumsViewHolder(Context context, ViewGroup parent) {
        super(UtilsUI.getInflaterFromContext(context).inflate(R.layout.header_albums_item, parent, false));
    }

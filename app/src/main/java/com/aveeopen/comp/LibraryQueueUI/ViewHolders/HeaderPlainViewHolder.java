...
public class HeaderPlainViewHolder
        extends BaseViewHolder {

    public HeaderPlainViewHolder(Context context, ViewGroup parent) {
        super(UtilsUI.getInflaterFromContext(context).inflate(R.layout.header_plain_item, parent, false));
    }

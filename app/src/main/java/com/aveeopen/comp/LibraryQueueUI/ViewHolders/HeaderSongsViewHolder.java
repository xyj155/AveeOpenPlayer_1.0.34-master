...
public class HeaderSongsViewHolder
    ...
    public HeaderSongsViewHolder(final Context context, ViewGroup parent) {
    ...
    public void onBind(final IContainerData containerData, int position) {
        ...
        if(libraryContainerDataListener != null)
            libraryContainerDataListener.subscribeWeakShowAlbumArtValueChanged(new WeakEvent1.Handler<Boolean>() {
                ...
                public void invoke(Boolean showAlbumArt) {
                    HeaderSongsViewHolder.this.onShowAlbumArtInsteadChanged(showAlbumArt);
                }
            }, listenerRefHolder);
        ...
        buttons[2].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                BaseHeaderViewHolder.onActionChooseSort.invoke(new ContextData(v));
            }
        });

...
public class WeakDelegate4<T1, T2, T3, T4> {
    ...
    public WeakDelegate4<T1, T2, T3, T4> subscribeWeak(Handler<T1, T2, T3, T4> listener, List<Object> listenerRefHolder) {
        listenerRefHolder.add(listener);
        listenerWeak = new WeakReference<>(listener);
        return this;
    }

    public Handler subscribeHoldWeak(Handler<T1, T2, T3, T4> listener) {
        listenerWeak = new WeakReference<>(listener);
        return listener;
    }

    public void invoke(T1 arg1, T2 arg2, T3 arg3, T4 arg4) {
        Handler<T1, T2, T3, T4> listener = listenerWeak.get();
        if (listener != null)

 ...
 * {@#getInstance} will return a {@link SystemUiHiderHoneycomb} instance,
 * while on older devices {@l#getInstance} will return a
...
//    }
    ...
    protected SystemUiHider(View anchorView, int flags) {
        //mActivity = activity;
